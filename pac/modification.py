            ...
            if ch==1:
                ...
                if data !="":
                    ...
                    for i in range(len(df)):
                        owners.append(df.loc[i].owner.owner)
                        contacts.append(df.loc[i].owner_contact.owner_contact)
                    #print(data, df.loc[a].owner.owner, owners, contacts)
                    contact=digit(data, df.loc[a].owner.owner, owners, contacts)
